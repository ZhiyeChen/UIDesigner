...
void CUICommandNode::Begin(CControlUI* pControl, LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	//TiXmlDocument xmlDoc("testBegin.xml");
...
BOOL CUICommandHistory::AddUICommand(CUICommandNode* pNode)
{
	...
	//	{
	//		TiXmlDocument xmlDoc1("testBefore.xml");
	//		xmlDoc1.InsertEndChild(*pNode->m_pBefore->m_pElementXml);
	//		xmlDoc1.Print();
	//		xmlDoc1.SaveFile();
	//	}
	//}
	//if (pNode->m_pAfter)
	//{
	//	if (pNode->m_pAfter->m_pElementXml)
	//	{
	//		TiXmlDocument xmlDoc2("testAfter.xml");
	//		xmlDoc2.InsertEndChild(*pNode->m_pAfter->m_pElementXml);
	//		xmlDoc2.Print();
	//		xmlDoc2.SaveFile();
	//		int n = 0;
	//	}
...
void CALLBACK CUICommandHistory::UIAdd(TiXmlNode* pNode)
{
	...
	//TiXmlDocument xmlDoc2("testUIAdd.xml");
	//xmlDoc2.InsertEndChild(*pElement);
	//xmlDoc2.Print();
	//xmlDoc2.SaveFile();
...
void CALLBACK CUICommandHistory::UIModify(TiXmlNode* pNode)
{
	...
	//TiXmlDocument xmlDoc("testUIModify.xml");
	//xmlDoc.InsertEndChild(*pElement);
	//xmlDoc.Print();
	//xmlDoc.SaveFile();
}
...
void CALLBACK CUICommandHistory::UIDelete(TiXmlNode* pNode)
{
	...
	//TiXmlDocument xmlDoc("testUIDelete.xml");
	//xmlDoc.InsertEndChild(*pElement);
	//xmlDoc.Print();
	//xmlDoc.SaveFile();
}